...
namespace DB1ChallangeFiapAPI.Repository
{
    public class UserRepository : IUserRepository
    {
        ...
        public async Task<int> CreateUserAsync(User user)
        {
            ...
            const string sql = @"INSERT INTO tb_user (fullname, email, born_dt, cellphone, city, u_state, u_type, u_password, u_description)
                                VALUES (@Fullname, @Email, @BornDate, @Cellphone, @City, @State, @UserType, @Password, @UserDescription);
